							...
							<div id="visor_fotos" class="tab-pane fade" height="100%">
								<div class="row">
									...
									<div class="panel panel-primary table-responsive">
										...
										<div class="panel-body">										
											<ul class="gallery">
										      Para realizar la consulta en el visor de registros fotograficos por favor seleccione el parametro de busqueda medidor, cuenta o fecha toma.
										      Para realizar busqueda por fecha digite la fecha con el siguiente formato (dd/mm/yyyy) Ejem: 17/11/2015
										    </ul>
										</div>	
									</div>
								</div>	
